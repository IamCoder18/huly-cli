...
| `~/.config/huly/bootstrap.json` | Per-`(host, workspace, account)` marker for completed workspace-identity bootstrap (mode 0600). Delete to force a re-bootstrap. |
